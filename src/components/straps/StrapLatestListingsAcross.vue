<template>
  <div class="strap-latest-listings-across">
    <div class="strap-container container pad-medium is-description">
...
export default {
  name: 'StrapLatestListingsAcross',
