    ...
    <div v-if="!hideResults && !hideListingResults">
      ...
      <template v-else>
        ...
        <div :class="galleryClass">
          ...
          <simple-gallery v-if="$store.getters.isIE11" :listing="listing" :strap="strap" />
          <listing-gallery v-else-if="!isLarge" :listing="listing" :strap="strap" />
          <large-listing-gallery v-else :forms="{ moreInfo: strap_state.formMoreInfo.formID, requestShowing: strap_state.formRequestShowing.formID }" :listing="listing" :strap="strap" />
        </div>
