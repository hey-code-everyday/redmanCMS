        ...
        <template v-else>
          ...
          >
            <template v-if="listings.length">
              ...
              >
                <large-open-house-card v-if="!isEREB" :listing="l" class="listing-card" />
                <listing-card-edm v-if="isEREB" :listing="l" :hasOpenHouse="true"/>
              </div>
            </template>
            <template v-else>
              <empty-card
...
import LargeOpenHouseCard from '@/components/LargeOpenHouseCard'
...
export default {
  ...
  initialState (strap, state) {
    return {
      title: defaultTitle({ html: 'Upcoming Open Houses' }),
      text: defaultQuill(),
        ...
        tabs: [
          {
            ...
            fields: [
              ...
              {
                key: 'state.orgChartOptions',
                type: 'dropdown',
                label: 'Brokerage Listings',
                default: 'slide',
                hint: 'Display results from an organization level',
                options () {
                  return getOrgChart.call(this)
                }
              }
            ]
          }
