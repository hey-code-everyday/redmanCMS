  ...
  <div class="custom-modal-listing-share">
    <div class="content">
      ...
      <div class="field is-grouped is-social-share">
        <div class="control">
          <a class="button is-primary is-twitter" :href="shareUrl('twitter')" target="_blank" @click="$customModal_close">
            <span class="icon"><i class="socicon-twitter"></i></span>
            <span>Twitter</span>
          </a>
        </div>
        <div class="control">
          <a class="button is-primary is-facebook" :href="shareUrl('facebook')" target="_blank" @click="$customModal_close">
            <span class="icon"><i class="socicon-facebook"></i></span>
            <span>Facebook</span>
          </a>
        </div>
        <div class="control">
          <a class="button is-primary is-email" :href="emailUrl()" target="_blank" @click="$customModal_close">
