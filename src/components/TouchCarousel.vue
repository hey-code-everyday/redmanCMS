<template>
  <div ref="carousel" class="touch-carousel" @mousedown="grabMouse" @touchstart="grabTouch">
    ...
    onResize () {
      ...
      this.resizeDebounce = setTimeout(() => {
        /*
          ...
          and calling getBoundingClientRect immediately after. getBoundingClientRect forces the browser to repaint
          the element
        */
